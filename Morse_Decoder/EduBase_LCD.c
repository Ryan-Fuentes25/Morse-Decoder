...
void EduBase_LCD_Ports_Init(void)
{
	...
	//R2 bit (Bit 2) in teh RCGCGPIO register
	...
	//Enable the digiital functionality for the PA6 pin
...
void EduBase_LCD_Init(void)
{
    ...
    // Transmit function set initialization commands as part of the LCD initialization
    ...
    // Transmit a Clear Display command to clear the display and set the DDRAM address
