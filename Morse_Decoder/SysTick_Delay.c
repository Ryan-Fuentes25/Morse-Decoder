...
// Global variable used to keep track of elapsed time continuously in microseconds
uint32_t us_elapsed_counter = 0;
...
{
	// Increment the continuous microsecond counter for main program logic
	us_elapsed_counter = us_elapsed_counter + 1;
